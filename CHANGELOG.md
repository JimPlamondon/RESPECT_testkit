...
- Extract the accepted RESPECT Compatible Test Suite, RESPECT-ification Kit, canonical Matrix, historical profile, public fixtures, schemas, validators, and source-locked standards bootstrap from `JimPlamondon/jims`.
- Convert bundled runtime resources to installed-package access without changing conformance semantics.
